...
os.system("clear")
access = input(f"{b}> Access Key: {Fore.RESET}")
Key = os.environ['Key']
if access == Key:
    print(f"{g}Access Granted! Launching.")
    time.sleep(1)
    os.system("clear")
    print(f"{b}> Access Key:{Fore.RESET} {Key}")
    print(f"{g}Access Granted! Launching..")
    time.sleep(1)
    os.system("clear")
    print(f"{b}> Access Key:{Fore.RESET} {Key}")
    ...
    print(f"{r}Incorect Key Granted. Exiting...")
    exit()
os.system("clear")
...
token = input(f"{b}> Token: {Fore.RESET}")
